...
//               if (this.isLoggedIn()) this.saveHistory('CONVERT');
...
//             next: (res) => {
//               this.result = res.value;
//               if (this.isLoggedIn()) this.saveHistory('ADD');
//               this.cd.detectChanges();
//             },
//             error: (err) => {
...
//             next: (res) => {
//               this.result = res.value;
//               if (this.isLoggedIn()) this.saveHistory('SUBTRACT');
//               this.cd.detectChanges();
//             },
//             error: (err) => {
//               console.error("Subtract Error:", err);
//               alert("Subtract failed");
//             }
//           });
//         break;
...
//             next: (res) => {
//               this.result = res;
//               if (this.isLoggedIn()) this.saveHistory('DIVIDE');
//               this.cd.detectChanges();
//             },
//             error: (err) => {
...
//               if (this.isLoggedIn()) this.saveHistory('COMPARE');
//               this.cd.detectChanges();
//             },
//             error: (err) => {
...
//   inputValue: this.value1,   // ✅ FIXED
//   inputUnit: this.unit1,     // ✅ FIXED

//   resultValue: this.result,  // ✅ FIXED
//   resultUnit: this.unit3     // ✅ FIXED
// };
